...
const Hero = () => {
  ...
  return <>
      ...
      <AnimatePresence>
        {fullscreenVideoId !== null && <motion.div initial={{
        opacity: 0
      }} animate={{
        opacity: 1
      }} exit={{
        ...
        duration: 0.3
      }} className="fixed inset-0 z-50 bg-background cursor-pointer" onClick={handleFullscreenClose}>
      ...
      <section className="hidden md:block w-full">
        ...
        <div className="h-[40vh] flex items-center justify-center relative pt-16">
          ...
          duration: 0.4
            ...
            duration: 0.7,
            ease: [0.16, 1, 0.3, 1]
          }} className="font-bold text-foreground leading-none whitespace-nowrap flex items-baseline justify-center gap-6" style={{
            fontSize: "clamp(4.5rem, 8vw, 10rem)"
          }}>
              <span className="font-cursive text-primary italic" style={{
            ...
            <div className="flex items-center justify-between w-full max-w-4xl mx-auto mt-10 px-4">
              <p className="text-muted-foreground opacity-0 animate-fade-up" style={{
              animationDelay: "0.4s",
              ...
              duration: 0.5,
              delay: 0.3
            }} className="font-cursive text-foreground/60" style={{
        ...
        <div className="relative h-[60vh]">
          ...
          <div ref={videoContainerRef} className="h-full overflow-y-auto px-8 lg:px-16 xl:px-24 pt-2 pb-8 py-[16px]" style={{
          scrollbarWidth: "none",
          msOverflowStyle: "none"
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-8 lg:gap-x-8 lg:gap-y-10">
              {videoProjects.map((project, index) => <motion.div key={project.id} className="cursor-pointer group" onMouseEnter={() => handleVideoHover(project.id)} onMouseLeave={handleVideoLeave} onClick={() => handleVideoClick(project.id)} initial={{
              opacity: 0,
              y: 30
            }} animate={{
              opacity: 1,
              ...
              duration: 0.5
                ...
                }} src={VIDEO_URL} poster={THUMBNAIL_URL} preload="metadata" loop muted playsInline className="w-full h-full object-cover" />
                  </div>
                </motion.div>)}
            </div>
          </div>
        ...
        <div className="relative h-[70vh]">
          ...
          msOverflowStyle: "none"
            ...
            <div className="grid grid-cols-1 gap-6">
              {videoProjects.map(project => <motion.div key={project.id} className="cursor-pointer" onClick={() => handleVideoClick(project.id)} whileTap={{
              scale: 0.98
            }}>
                  {/* Header with serial number, client and subtitle */}
                  ...
                  <div className="relative aspect-video rounded-lg overflow-hidden">
                    <video src={VIDEO_URL} poster={THUMBNAIL_URL} preload="metadata" loop muted playsInline autoPlay className="w-full h-full object-cover" />
                  </div>
                </motion.div>)}
            </div>
          </div>
